return {
  SINGULAR =
  {
    [PERISHABLE_STALE_SUFFIX_KEY] = STRINGS.SUFFIX.PERISHABLE.STALE.MALE.SINGULAR, -- Rancio.
    [PERISHABLE_SPOILED_SUFFIX_KEY] = STRINGS.SUFFIX.PERISHABLE.SPOILED.MALE.SINGULAR, -- Caducado.
  ...
  PLURAL =
  {
    [PERISHABLE_STALE_SUFFIX_KEY] = STRINGS.SUFFIX.PERISHABLE.STALE.MALE.PLURAL, -- Rancios.
    [PERISHABLE_SPOILED_SUFFIX_KEY] = STRINGS.SUFFIX.PERISHABLE.SPOILED.MALE.PLURAL, -- Caducados.
